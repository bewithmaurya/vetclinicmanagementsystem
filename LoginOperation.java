...
public class LoginOperation extends Base 
{
	...
	// <------DOCTOR LOGIN----------->//
	public boolean doc_loginValidate() 
	{
		super.conn = Connections.getConnections();
		sqlquery = "SELECT USERID,PASSWORD FROM DOCTOR_DETAILS";
		try 
		{
			super.ps = super.conn.prepareStatement(sqlquery);
		} 
	...
	// <------RECEPTIONIST LOGIN----------->//
	public boolean rec_loginValidate()
	{
		super.conn = Connections.getConnections();
		sqlquery = "SELECT USERID,PASSWORD FROM RECEPTIONIST_DETAILS";
		try 
		{
			super.ps = super.conn.prepareStatement(sqlquery);
		} 
	...
	// <------EMPLOYEE LOGIN----------->//
	public boolean emp_loginValidate() 
	{
		super.conn = Connections.getConnections();
