...
class RecUpdate extends ValidateForm implements ActionListener
{
	public JFrame frm;
	public PreparedStatement ps;
	public ResultSet rs;
	public Connection conn;
	public JButton btnEdit, btnUploade, btnCANCEL;
	...
	public JTextField txtUser_Id, txtsAnswer, txtimg, txtDOB, txtSearch, txtMob_No, txtEmailId;
	...
	RecUpdate() 
	{
		...
		lblRegister = new JLabel("Update Profile");
		lblRegister.setForeground(Color.WHITE);
		lblRegister.setFont(new Font("Magneto", Font.BOLD, 23));
		lblRegister.setBounds(300, 60, 300, 27);
		frm.add(lblRegister);
		...
		lblName = new JLabel();
		lblName.setBounds(570, 110, 250, 30);
...
public class ReceptionistUpdateProfile 
{
