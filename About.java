...
class abt
{
	...
	abt()
	{
		...
		JLabel lblVeteneriyManagementSystem = new JLabel("Veterinary Management System");
		lblVeteneriyManagementSystem.setBounds(120, 20, 197, 14);
		contentPane.add(lblVeteneriyManagementSystem);
		...
		JLabel lblCompanyShubhtechno = new JLabel("Company: ShubhTechno");
