...
class AdminUpdate implements ActionListener
{
	...
	public JLabel lblVeterinaryManagementSystem, lblUpdateProfile, barlabel, lbluser, lblsAnswer, lblpass, lblconfpass, lblsQueston, lblName;
	...
	AdminUpdate() 
	{
		...
		lblVeterinaryManagementSystem.setFont(new Font("Algerian", Font.BOLD, 20));
		lblVeterinaryManagementSystem.setForeground(Color.WHITE);
		lblVeterinaryManagementSystem.setBounds(25, 5, 635, 30);
		frm.add(lblVeterinaryManagementSystem);

		Canvas canvas = new Canvas();
		canvas.setBackground(Color.WHITE);
		canvas.setForeground(Color.RED);
		canvas.setBounds(25, 35, 370, 3);
		frm.add(canvas);

		lblUpdateProfile = new JLabel("Update Profile");
		lblUpdateProfile.setForeground(Color.WHITE);
		lblUpdateProfile.setFont(new Font("Magneto", Font.BOLD, 16));
		lblUpdateProfile.setBounds(150, 42, 300, 27);
