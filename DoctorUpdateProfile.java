...
class DocUpdate implements ActionListener 
{
	public JFrame frm;
	public JButton btnUploade, btnEdit, btnCANCEL;
	public JLabel lblVeterinaryManagementSystem, lblUpdateProfile, barlabel, lblId, lbluser, lblsAnswer, lblpass, lblconfpass, lblimg, lblsQueston, lblEmailId, lblSpez, lblName, lblDOB, lblQualifaction, lblGender, lblFull_Address, lblMob_No, lblPhoto, lbllogo;
