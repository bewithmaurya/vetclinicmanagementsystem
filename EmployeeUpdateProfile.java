...
class EmpUpdate implements ActionListener 
{
	public static String admno = null;
	public JFrame frm;
	public JButton btnUploade, btnEdit, btnCANCEL;
	public JLabel lblVeterinaryManagementSystem, lblUpdateProfile, barlabel, lblId, lbluser, lblsAnswer, lblpass,lblconfpass, lblimg, lblsQueston, lblEmailId, lblName, lblDOB, lblGender, lblFull_Address, lblMob_No;
	public JTextField txtUser_Id, txtsAnswer, txtName, txtDOB, txtMob_No, txtEmailId, txtimg;
	...
	EmpUpdate() 
	{
		...
		lblUpdateProfile.setBounds(300, 60, 204, 27);
	...
	public boolean frmvalidate() 
	{
		...
		else if (txtUser_Id.getText().length() == 0) 
		{
